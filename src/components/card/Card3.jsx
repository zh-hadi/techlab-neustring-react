            ...
            <div className='flex flex-col md:flex-row h-full w-full'>
                ...
                <div className='text-xl font-bold text-white flex gap-2 items-center'>
                    ...
                    <div className='space-y-5'>
                        <h2 className='text-left md:text-right font-bold text-4xl text-white'>{data.title}</h2>
                        <p className='text-left md:text-right text-white'>{data.description}</p>
                    </div>
                    <div>
                        <a href={data.url} className='text-white  px-3 py-2 rounded-md text-md self-stretch font-medium' style={{ backgroundColor: 'rgba(255, 255, 255, 0.1)'}}>Learn More</a>
                    </div>
